...
export default function MostSearchedBreed() {
  ...
  return (
    <section className='mb-28'>
      <h1 className='xs:text-2xl sm:text-3xl xl:text-4xl text-[#291507] font-bold'>
      ...
      <div className='flex flex-col gap-[55px] mt-12'>
        {breeds?.map((breed, index) => (
          ...
          >
            ...
            <div>
              <p className='font-semibold xs:text-2xl xl:text-4xl text-[#291507]'>
                {index + 1}. {breed.name}
              </p>
              <p className='xs:text-sm lg:text-lg text-[#291507] font-medium leading-7 mt-6 text-justify'>
                {breed.description}
              </p>
            </div>
          </Link>
